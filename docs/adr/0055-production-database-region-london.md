...
- **Process debt.** Running `prisma migrate deploy` from a laptop against production is fragile; folding it into a gated pipeline is done for prod (`release.yml`) and specified for preprod by [ADR-0075](0075-one-environment-model.md) / #875.
