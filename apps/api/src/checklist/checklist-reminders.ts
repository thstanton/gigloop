...
// deliverables are now multi-step goals — their old flat steps (send_quote, create_contract,
// create_balance_invoice, music_form_invite, …) are intrinsically ordered within their goal and no
// longer appear in any goal's `dependsOn`, so their prerequisite phrases retire. What remains is
// the cross-concern dependency send_thank_you ← play_the_gig.
