import { PrismaClient, SongGenre } from '@prisma/client';
...
async function main() {
  ...
  await prisma.song.createMany({
    data: [
      { userId: USER_ID, title: 'Thinking Out Loud', artist: 'Ed Sheeran', genre: SongGenre.CONTEMPORARY, active: true, tags: ['romantic', 'popular'] },
      { userId: USER_ID, title: 'All of Me', artist: 'John Legend', genre: SongGenre.CONTEMPORARY, active: true, tags: ['romantic'] },
      { userId: USER_ID, title: 'A Thousand Years', artist: 'Christina Perri', genre: SongGenre.CONTEMPORARY, active: true, tags: ['romantic', 'wedding'] },
      { userId: USER_ID, title: 'Perfect', artist: 'Ed Sheeran', genre: SongGenre.CONTEMPORARY, active: true, tags: ['romantic', 'popular'] },
      { userId: USER_ID, title: "Can't Help Falling in Love", artist: 'Elvis Presley', genre: SongGenre.CONTEMPORARY, active: true, tags: ['classic', 'romantic'] },
      { userId: USER_ID, title: 'Make You Feel My Love', artist: 'Bob Dylan', genre: SongGenre.CONTEMPORARY, active: true, tags: ['romantic'] },
      { userId: USER_ID, title: 'The Scientist', artist: 'Coldplay', genre: SongGenre.CONTEMPORARY, active: true, tags: [] },
      { userId: USER_ID, title: 'Your Song', artist: 'Elton John', genre: SongGenre.CONTEMPORARY, active: true, tags: ['classic', 'romantic'] },
      { userId: USER_ID, title: 'Canon in D', artist: 'Pachelbel', genre: SongGenre.CLASSICAL, active: true, tags: ['processional', 'ceremony'] },
      { userId: USER_ID, title: 'Clair de Lune', artist: 'Debussy', genre: SongGenre.CLASSICAL, active: true, tags: ['instrumental'] },
      { userId: USER_ID, title: 'Air on the G String', artist: 'Bach', genre: SongGenre.CLASSICAL, active: true, tags: ['processional', 'ceremony'] },
      { userId: USER_ID, title: 'Gymnopédie No. 1', artist: 'Satie', genre: SongGenre.CLASSICAL, active: true, tags: ['instrumental', 'ambient'] },
      { userId: USER_ID, title: 'Moonlight Sonata', artist: 'Beethoven', genre: SongGenre.CLASSICAL, active: true, tags: ['instrumental'] },
      { userId: USER_ID, title: 'Hallelujah', artist: 'Leonard Cohen (arr. classical)', genre: SongGenre.CLASSICAL, active: true, tags: ['ceremony'] },
      { userId: USER_ID, title: 'Fly Me to the Moon', artist: 'Frank Sinatra', genre: SongGenre.JAZZ, active: true, tags: ['upbeat', 'popular'] },
      { userId: USER_ID, title: 'The Way You Look Tonight', artist: 'Frank Sinatra', genre: SongGenre.JAZZ, active: true, tags: ['romantic'] },
      { userId: USER_ID, title: 'Autumn Leaves', artist: 'Standard', genre: SongGenre.JAZZ, active: true, tags: [] },
      { userId: USER_ID, title: 'Misty', artist: 'Erroll Garner', genre: SongGenre.JAZZ, active: true, tags: [] },
      { userId: USER_ID, title: 'At Last', artist: 'Etta James', genre: SongGenre.JAZZ, active: true, tags: ['romantic', 'first dance'] },
      { userId: USER_ID, title: 'Summertime', artist: 'Gershwin', genre: SongGenre.JAZZ, active: true, tags: [] },
      { userId: USER_ID, title: 'What a Wonderful World', artist: 'Louis Armstrong', genre: SongGenre.JAZZ, active: true, tags: ['popular'] },
      { userId: USER_ID, title: 'A Whole New World', artist: 'Aladdin', genre: SongGenre.FILM_TV_MUSICALS, active: true, tags: ['popular'] },
      { userId: USER_ID, title: 'Beauty and the Beast', artist: 'Disney', genre: SongGenre.FILM_TV_MUSICALS, active: true, tags: ['romantic'] },
      { userId: USER_ID, title: 'Somewhere Over the Rainbow', artist: 'Wizard of Oz', genre: SongGenre.FILM_TV_MUSICALS, active: true, tags: ['classic'] },
      { userId: USER_ID, title: 'My Heart Will Go On', artist: 'Celine Dion', genre: SongGenre.FILM_TV_MUSICALS, active: true, tags: ['romantic'] },
      { userId: USER_ID, title: 'Can You Feel the Love Tonight', artist: 'The Lion King', genre: SongGenre.FILM_TV_MUSICALS, active: true, tags: ['romantic'] },
      { userId: USER_ID, title: 'Tujh Mein Rab Dikhta Hai', artist: 'Rab Ne Bana Di Jodi', genre: SongGenre.BOLLYWOOD, active: true, tags: ['romantic'] },
      { userId: USER_ID, title: 'Kabhi Khushi Kabhie Gham', artist: 'Film Soundtrack', genre: SongGenre.BOLLYWOOD, active: true, tags: [] },
      { userId: USER_ID, title: 'Dil Se Re', artist: 'AR Rahman', genre: SongGenre.BOLLYWOOD, active: true, tags: [] },
      { userId: USER_ID, title: 'White Christmas', artist: 'Bing Crosby', genre: SongGenre.CHRISTMAS, active: true, tags: ['classic'] },
      { userId: USER_ID, title: 'Have Yourself a Merry Little Christmas', artist: 'Traditional', genre: SongGenre.CHRISTMAS, active: true, tags: [] },
      { userId: USER_ID, title: 'The Christmas Song', artist: 'Nat King Cole', genre: SongGenre.CHRISTMAS, active: true, tags: ['classic'] },
      { userId: USER_ID, title: 'O Holy Night', artist: 'Traditional', genre: SongGenre.CHRISTMAS, active: true, tags: [] },
    ],
  });
  ...
  await prisma.musicFormConfig.create({
    data: {
      userId: USER_ID,
      bookingId: booking3.id,
      enabledGenres: [SongGenre.CONTEMPORARY, SongGenre.CLASSICAL, SongGenre.JAZZ],
