...
function SetEditRow({
  ...
  return (
    <div className="grid grid-cols-[1fr_4rem_5rem_auto] items-center gap-2 py-2 border-b border-border last:border-0">
      <input
        type="text"
      ...
      <div className="flex items-center gap-1">
        <input
          ...
          className="text-sm text-foreground border border-border rounded px-2 py-0.5 bg-background w-full text-right"
          aria-label="Duration in minutes"
        />
        <span className="text-xs text-muted flex-shrink-0">m</span>
      </div>
      <input
        type="time"
      ...
      {(booking.performanceFormats ?? []).map((bpf) => {
        ...
        return (
          <div key={bpf.id} className="mb-5">
            ...
            {sets.length > 0 && (
              <div className="text-xs text-muted grid grid-cols-[1fr_4rem_5rem_auto] gap-2 pb-1 mb-1 border-b border-border">
                <span>Label</span>
