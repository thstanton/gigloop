...
export function useInvoiceActions(bookingId: string) {
  ...
  return {
    ...
    voidingInvoiceId: voidInvoiceMutation.isPending ? (voidInvoiceMutation.variables ?? null) : null,
    markPaid: (invoiceId: string) => markPaidMutation.mutate(invoiceId),
    isMarkingPaid: markPaidMutation.isPending,
    markingPaidId: markPaidMutation.isPending ? (markPaidMutation.variables ?? null) : null,
    markSent: (invoiceId: string) => markSentMutation.mutate(invoiceId),
    isMarkingSent: markSentMutation.isPending,
    markingSentId: markSentMutation.isPending ? (markSentMutation.variables ?? null) : null,
